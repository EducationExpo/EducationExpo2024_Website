        ...
        <div className="et-banner-slider swiper">
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide">
              <div style={{ backgroundImage: 'url("assets/img/banner-bg-1.jpg")' }} className="bg-no-repeat bg-cover bg-center pt-[clamp(150px,17.3vw,333px)] pb-[clamp(120px,22vw,422px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-etBlue/40 before:-z-[1]">
                <div className="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px]">
                  <div className="flex md:flex-col items-center justify-between gap-x-[30px] gap-y-[30px] md:grid-cols-1">
                    <div className="left relative z-[20] w-[55%] md:w-full">
                      <h6 className="font-kalam font-bold text-[2.4rem] mb-[3px] anim-text">Education Expo 2024</h6>
                      <h1 className="text-[clamp(42px,6.25vw,12rem)] font-semibold leading-[1.1] mb-[36px] md:mb-[36px] anim-text">Aurangabad Education Expo <span className="font-normal tracking-tighter"> 2024</span></h1>
                      {/* <div className="et-banner-btns flex flex-wrap items-center gap-[20px]">
                        <a href="contact.html" className="et-btn bg-etBlue inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] text-white font-normal text-[17px] rounded-full hover:!bg-white hover:!text-etBlue">Register Now</a>
                        <a href="/" className="et-btn bg-white inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] text-etBlue font-normal text-[17px] rounded-full">View More</a>
                      </div> */}
                      {/* vectors */}
                      <div className="et-banner-vectors">
                        <div className="absolute left-[457px] bottom-[calc(100%+40px)]"><img src="assets/img/banner-vector.png" alt="vector" className="w-[45px] h-[45px]" /></div>
                        <div className="absolute bottom-0 right-[6px]"><img src="assets/img/banner-vector.png" alt="vector" className="w-[21px] h-[21px]" /></div>
                      </div>
                    </div>
                    {/* video button */}
                    <div className="et-banner-video-btn w-[40%] md:w-full shrink-0">
                      <a href="https://www.youtube.com/watch?v=0RuxVKKbE9U&ab_channel=AurangabadEducationExpos" data-fslightbox="banner-video-1" className="w-[135px] aspect-square rounded-full border border-white/20 flex justify-center items-center text-etBlue ml-auto mr-[230px] lg:mr-[150px] md:mr-auto md:ml-0 relative z-[1] text-[18px] before:absolute before:w-[70px] before:h-[70px] before:bg-white before:rounded-full before:-z-[1] before:transition before:duration-[400ms] hover:text-white hover:before:bg-etBlue hover:border-etBlue"><i className="fa-solid fa-play" /></a>
                    </div>
                  </div>
                </div>
                {/* bottom title */}
            ...
            {/* single slide */}
            <div className="swiper-slide">
              <div style={{ backgroundImage: 'url("assets/img/banner-bg-2.jpg")' }}  className="bg-no-repeat bg-cover bg-center pt-[clamp(150px,17.3vw,333px)] pb-[clamp(120px,22vw,422px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-etBlue/40 before:-z-[1]">
                <div className="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px]">
                  <div className="flex md:flex-col items-center justify-between gap-x-[30px] gap-y-[30px] md:grid-cols-1">
                    <div className="left relative z-[20] w-[55%] md:w-full">
                      <h6 className="font-kalam font-bold text-[2.4rem] mb-[3px] anim-text">Education Expo 2024</h6>
            ...
            {/* single slide */}
            <div className="swiper-slide">
              <div style={{ backgroundImage: 'url("assets/img/banner-bg-3.jpg")' }}  className="bg-no-repeat bg-cover bg-center pt-[clamp(150px,17.3vw,333px)] pb-[clamp(120px,22vw,422px)] text-white relative overflow-hidden z-[1] before:content-normal before:absolute before:inset-0 before:bg-etBlue/40 before:-z-[1]">
                <div className="mx-[15.5em] xxxl:mx-[10em] xxl:mx-[40px] xs:mx-[12px]">
                  <div className="flex md:flex-col items-center justify-between gap-x-[30px] gap-y-[30px] md:grid-cols-1">
                    <div className="left relative z-[20] w-[55%] md:w-full">
                      <h6 className="font-kalam font-bold text-[2.4rem] mb-[3px] anim-text">Education Expo 2024</h6>
          ...
          <div className="flex items-center md:flex-wrap gap-x-[60px] xxl:gap-x-[40px] lg:gap-x-[30px] gap-y-[40px] sm:gap-y-[40px] lg:justify-center">
            ...
            <div className="et-about__txt">
              ...
              <div className="flex flex-wrap items-center gap-x-[30px] gap-y-[16px] rev-slide-up">
                <a href="contact.html" className="et-btn bg-etBlue inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] text-white font-normal text-[17px] rounded-full hover:!bg-black hover:!text-white">Register Now</a>
      ...
      <div className="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full rev-slide-up relative z-[2]">
        <div className="bg-etBlue relative z-[1] p-[60px] sm:p-[40px] xs:px-[20px] rounded-[20px] overflow-hidden -mb-[114px] shadow-[0_4px_50px_rgba(18,96,254,0.2)] after:absolute after:inset-0 after:-z-[1] after:bg-[url(../assets/img/et-counter-bg.jpg)] after:bg-cover after:bg-no-repeat after:mix-blend-screen flex items-center md:flex-wrap gap-y-[20px]">
          <div className="pr-[54px] border-r md:border-r-0 border-white/20 md:text-center md:pr-0 md:w-full">
            ...
            <a href="contact.html" className="et-btn bg-etBlue inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] text-white font-normal text-[17px] rounded-full border-white border hover:!bg-white hover:!text-etBlue">Buy Ticket</a>
          </div>
          {/* counter */}
        ...
        <div className="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full rev-slide-up">
          ...
          <div className="grid grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xxs:grid-cols-1 gap-[30px] lg:gap-[20px]">
            ...
            <div className="rounded-[20px] bg-white overflow-hidden group">
              ...
              {/* text */}
              <div className="px-[30px] xxl:px-[20px] py-[23px] xxl:py-[18px]">
                <h5 className="font-medium text-[22px] text-etBlack mb-[8px]"><a href="/" className="hover:text-etBlue">Engaging Keynote</a></h5>
                <p className="font-light text-etGray text-[16px]">Mauris ultrices ligula eget volutpat aliquet nullam</p>
              </div>
            </div>
            {/* single card */}
          ...
          <div className="et-schedule-heading flex sm:flex-col justify-between items-center pb-[31px] mb-[40px] gap-[15px] border-b border-[#D9D9D9]">
            ...
            <div className="right">
              <div className="et-schedules-tab-navs bg-[#EDF3FE] px-[12px] py-[14px] flex flex-w gap-[16px] sm:gap-[12px] rounded-full">
                <button data-tab="tab1" className="tab-nav bg-etBlack rounded-full px-[20px] py-[3px] text-[16px] font-medium text-white hover:bg-etBlue active">Day 01</button>
                <button data-tab="tab2" className="tab-nav bg-etBlack rounded-full px-[20px] py-[3px] text-[16px] font-medium text-white hover:bg-etBlue">Day 02</button>
                <button data-tab="tab3" className="tab-nav bg-etBlack rounded-full px-[20px] py-[3px] text-[16px] font-medium text-white hover:bg-etBlue">Day 03</button>
              </div>
            </div>
          </div>
          {/* events */}
            ...
            <div id="tab1" className="et-tab active">
              <div className="all-scheduled-events space-y-[30px]">
                ...
                <div className="et-schedule flex md:flex-wrap gap-x-[30px] gap-y-[20px] justify-between rev-slide-up">
                  {/* img */}
                  <div className="w-[270px] h-[226px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] shrink-0 rounded-[20px] overflow-hidden"><img src="assets/img/evenet-sched-1.jpg" alt="scehduled-event-cover" /></div>
                  {/* text */}
                  <div className="px-[37px] sm:px-[22px] py-[30px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] w-full rounded-[20px] flex gap-y-[15px] xs:flex-col items-center xs:items-start">
                    <div className="et-schedule__heading pr-[40px] sm:pr-[25px] xs:pr-0 mr-[40px] sm:mr-[25px] xs:mr-0 border-r xs:border-r-0 border-[#d9d9d9]">
                      ...
                      {/* title */}
                      <h3 className="et-schedule-title text-[24px] sm:text-[22px] font-regular text-etBlack leading-[1.25] mb-[16px] anim-text"><a href="event-details.html" className="hover:text-etBlue">Siempre Son Flores" Musica Cubana Salsa Jazz adipi scing elit. Nullam</a></h3>
                      {/* location */}
                    ...
                    <div className="flex shrink-0 xxl:flex-col flex-wrap items-center xxl:items-start gap-x-[30px] gap-y-[16px]">
                      <a href="event-details.html" className="et-btn border border-etBlue text-etBlue inline-flex items-center justify-center gap-x-[13px] h-[45px] px-[15px] font-normal text-[17px] rounded-full hover:!bg-etBlue hover:!text-white">Buy Tickets</a>
                      <div className="flex items-center">
                        <div className="flex *:-ml-[20px]">
                          ...
                          <div className="w-[45px] h-[45px] rounded-full border-[3px] border-white first:ml-0 text-white bg-etBlue font-semibold flex items-center justify-center text-[16px]" />
                        </div>
                        <span className="font-semibold text-etBlue text-[16px] -ml-[29px]"><span className="text-white">Spe</span>akers</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="et-schedule flex md:flex-wrap gap-x-[30px] gap-y-[20px] justify-between rev-slide-up">
                  {/* img */}
                  <div className="w-[270px] h-[226px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] shrink-0 rounded-[20px] overflow-hidden"><img src="assets/img/evenet-sched-2.jpg" alt="scehduled-event-cover" /></div>
                  {/* text */}
                  <div className="px-[37px] sm:px-[22px] py-[30px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] w-full rounded-[20px] flex gap-y-[15px] xs:flex-col items-center xs:items-start">
                    <div className="et-schedule__heading pr-[40px] sm:pr-[25px] xs:pr-0 mr-[40px] sm:mr-[25px] xs:mr-0 border-r xs:border-r-0 border-[#d9d9d9]">
                      {/* date & time */}
                ...
                <div className="et-schedule flex md:flex-wrap gap-x-[30px] gap-y-[20px] justify-between rev-slide-up">
                  {/* img */}
                  <div className="w-[270px] h-[226px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] shrink-0 rounded-[20px] overflow-hidden"><img src="assets/img/evenet-sched-3.jpg" alt="scehduled-event-cover" /></div>
                  {/* text */}
                  <div className="px-[37px] sm:px-[22px] py-[30px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] w-full rounded-[20px] flex gap-y-[15px] xs:flex-col items-center xs:items-start">
                    <div className="et-schedule__heading pr-[40px] sm:pr-[25px] xs:pr-0 mr-[40px] sm:mr-[25px] xs:mr-0 border-r xs:border-r-0 border-[#d9d9d9]">
                      {/* date & time */}
              ...
              <div className="swiper-slide">
                <div className="et-speaker bg-white rounded-[16px] relative z-[1] group">
                  ...
                  <div className="et-speaker-socials bg-[#E7EFFF] w-[55px] py-[15px] text-center rounded-full absolute z-[2] -left-[10px] -top-[10px] flex flex-col justify-center text-[20px] text-etGray2 gap-[10px] border-[10px] border-white box-content">
                    <a href="/" className="hover:text-etBlue"><i className="fa-brands fa-facebook-f" /></a>
                    <a href="/" className="hover:text-etBlue"><i className="fa-brands fa-instagram" /></a>
                    <a href="/" className="hover:text-etBlue"><i className="fa-brands fa-twitter" /></a>
                    <a href="/" className="hover:text-etBlue"><i className="fa-brands fa-pinterest-p" /></a>
                  </div>
                  <div className="et-speaker-txt text-center absolute z-[1] bottom-0 pb-[24px] w-full text-white translate-y-full group-hover:translate-y-0 transition duration-[400ms]">
                    <h4 className="et-speaker-name font-medium text-[24px] mb-[3px]"><a href="team-member-details.html" className="hover:text-black">Esther Howard</a></h4>
          ...
          <div className="swiper-wrapper">
            ...
            <div className="swiper-slide even:mt-[80px] xs:even:mt-0">
              <div className="et-testimony p-[40px] lg:p-[30px] md:p-[20px] border border-[#256E56]/10 bg-white rounded-[16px]">
                ...
                <p className="text-etBlack/70 font-normal text-[16px] mb-[40px]">"Choosing eventek was one of the best decisions for our marketing strategy. They not only promised results but delivered them consistently. Trustworthy, reliable, and results-oriented. We're grateful for their strategic insights
          ...
          <div className="grid grid-cols-3 sm:grid-cols-2 xs:grid-cols-1 gap-[30px] md:gap-[20px]">
            ...
            <div className="bg-[url('../assets/img/pricing-bg.jpg')] rounded-[30px] overflow-hidden bg-no-repeat bg-cover bg-center relative z-[1] shadow-[0_4px_60px_rgba(18,96,254,0.12)] rev-slide-up before:absolute before:inset-0 before:bg-etBlue/85 before:-z-[1] text-center">
              ...
              <a href="/" className="my-[30px] inline-flex items-center gap-[12px] rounded-full border border-white/20 text-white h-[54px] px-[15px] text-[17px] group hover:bg-white hover:border-white hover:text-etBlue">
                <span className="icon">
                  <svg width={18} height={20} viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M13.1023 17.6473C13.0496 17.6473 12.9979 17.6511 12.9471 17.6578C12.4966 16.1361 11.1883 14.9794 9.5848 14.7503V13.6641H8.41524V14.7503C6.81011 14.9796 5.50077 16.1384 5.05156 17.6624C4.99031 17.6526 4.92753 17.6473 4.86351 17.6473C4.21347 17.6473 3.68652 18.1742 3.68652 18.8242C3.68652 19.4742 4.21347 20.0012 4.86351 20.0012C5.4544 20.0012 5.94345 19.5657 6.0276 18.9982C6.04471 18.9433 6.05393 18.8848 6.05393 18.8242C6.05393 17.3999 7.06993 16.2086 8.41524 15.9366V17.791C8.04998 17.9908 7.80223 18.3786 7.80223 18.8242C7.80223 19.4742 8.32918 20.0012 8.97918 20.0012C9.62922 20.0012 10.1562 19.4742 10.1562 18.8242C10.1562 18.3957 9.92708 18.0208 9.5848 17.815V15.9366C10.8716 16.1968 11.8565 17.2982 11.9398 18.6401C11.9303 18.7001 11.9253 18.7616 11.9253 18.8243C11.9253 19.4743 12.4523 20.0012 13.1023 20.0012C13.7523 20.0012 14.2793 19.4743 14.2793 18.8243C14.2793 18.1743 13.7523 17.6473 13.1023 17.6473Z" className="fill-white group-hover:fill-etBlue transition duration-[0.4s]" />
                    <path d="M17.2036 6.2168H15.6151C15.2921 6.2168 15.0303 6.47861 15.0303 6.8016V8.5676C15.0303 9.11044 14.5882 9.55211 14.0447 9.55211H13.9074C13.9062 9.55211 13.9051 9.55227 13.904 9.55227V9.55211H4.09592V9.55227C4.09478 9.55227 4.09365 9.55211 4.09252 9.55211H4.07443C3.53096 9.55211 3.08883 9.11044 3.08883 8.5676V6.8016C3.08883 6.47861 2.82701 6.2168 2.50403 6.2168H0.796348C0.47336 6.2168 0.211548 6.47861 0.211548 6.8016C0.211548 7.12458 0.47336 7.3864 0.796348 7.3864H1.91927V8.5676C1.91927 9.75536 2.88608 10.7217 4.07443 10.7217H4.09252C4.09369 10.7217 4.09478 10.7216 4.09592 10.7216V10.9282C4.09592 11.7911 4.79553 12.4908 5.65851 12.4908H12.3414C13.2044 12.4908 13.904 11.7911 13.904 10.9282V10.7216C13.9051 10.7216 13.9063 10.7217 13.9074 10.7217H14.0447C15.2331 10.7217 16.1999 9.7554 16.1999 8.5676V7.3864H17.2036C17.5265 7.3864 17.7884 7.12458 17.7884 6.8016C17.7884 6.47865 17.5265 6.2168 17.2036 6.2168Z" className="fill-white group-hover:fill-etBlue transition duration-[0.4s]" />
                    <path d="M13.1157 2.14739C13.1157 0.963338 12.1524 0 10.9683 0H7.03167C5.84758 0 4.88428 0.963299 4.88428 2.14739V8.38037H13.1157V2.14739Z" className="fill-white group-hover:fill-etBlue transition duration-[0.4s]" />
                  </svg>
                </span>
                <span>Register Now</span>
              </a>
      ...
      <section className="grid grid-cols-4 lg:grid-cols-3 sm:grid-cols-2">
        ...
        <div className="bg-etBlue xxs:col-span-2 relative z-[1] flex items-center justify-center text-center before:absolute before:inset-0 before:bg-[url('assets/img/gallery-text-bg.jpg')] before:-z-[1] before:mix-blend-multiply p-[15px] xxs:pt-[25px] xxs:pb-[30px]">
          <div>
            ...
            <a href="gallery.html" className="inline-flex items-center justify-center rounded-full border border-white text-[16px] h-[45px] px-[15px] text-white hover:bg-white hover:text-etBlue">View All Gallery</a>
          </div>
        </div>
        {/* single gallery item */}
              ...
              <div className="relative">
                ...
                <div className="absolute inset-[40px] top-auto flex rounded-[20px] overflow-hidden bg-white xxs:flex-col">
                  ...
                  <div className="flex items-center justify-center w-full">
                    <a href="/" className="bg-etBlue rounded-full text-white h-[45px] px-[15px] text-[17px] my-[10px] flex items-center justify-center hover:bg-white hover:text-etBlue">Get Direction</a>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-3 md:grid-cols-2 xs:grid-cols-1 justify-center gap-[30px] lg:gap-[20px]">
            ...
            <div className="et-blog bg-white relative p-[30px] lg:p-[20px] rounded-[20px] group">
              ...
              <div className="et-blog__txt">
                <h4 className="et-blog__title text-[20px] sm:text-[18px] font-medium mb-[11px]"><a href="/" className="hover:text-etBlue">Cupidatat Nonproident, Sunt in Culpa Qui Officia Deserunt</a></h4>
                <div className="et-blog__infos flex gap-x-[22px] mb-[25px]">
                  {/* single info */}
                  <div className="et-blog-info flex items-center gap-x-[10px]">
                    <span className="icon"><svg width={13} height={14} viewBox="0 0 18 20" fill="none" xmlns="http://www.w3.org/2000/svg">
