...
export default function About() {
  ...
  <section className="et-breadcrumb bg-[#000D83] pt-[210px] lg:pt-[190px] sm:pt-[160px] pb-[130px] lg:pb-[110px] sm:pb-[80px] relative z-[1] before:absolute before:inset-0 before:bg-[url('assets/img/breadcrumb-bg.jpg')] before:bg-no-repeat before:bg-cover before:bg-center before:-z-[1] before:opacity-30">
    <div className="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full text-center text-white">
      <h1 className="et-breadcrumb-title font-medium text-[56px] md:text-[50px] xs:text-[45px]">About us</h1>
      <ul className="inline-flex items-center gap-[10px] font-medium text-[16px]">
        <li className="opacity-80"><a href="index.html" className="hover:text-etBlue">Home</a></li>
        <li><i className="fa-solid fa-angle-right" /><i className="fa-solid fa-angle-right" /></li>
  ...
  <section className="bg-[#001B52] relative z-[1] before:absolute before:inset-0 before:-z-[1] before:bg-[url('assets/img/history-bg.jpg')] before:bg-no-repeat before:bg-cover before:bg-center before:mix-blend-screen before:opacity-25 py-[130px] lg:py-[80px] md:py-[60px]">
    <div className="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
      ...
      <div className="et-upcoming-events-heading text-center max-w-[60%] mx-auto mb-[52px] xl:mb-[42px] lg:mb-[32px] md:max-w-[70%] sm:max-w-[80%] xs:max-w-full">
        <h6 className="et-section-sub-title !text-white">Company History</h6>
        <h2 className="et-section-title !text-white">Our Eventek Internasal Design Conferences History</h2>
      </div>
      {/* main slider */}
          ...
          <div className="swiper-slide">
            <div className="grid grid-cols-2 md:grid-cols-1 gap-[30px]">
              <div className="rounded-[20px] overflow-hidden">
                <img src="assets/img/history-img.jpg" alt="History image" className="w-full h-full object-cover" />
              </div>
              <div className="bg-white rounded-[20px] px-[30px] py-[20px] xxs:px-[20px]">
                <h5 className="text-[24px] font-normal mb-[13px]">Welcome to Eventek</h5>
                <div className="txt mb-[40px]">
                  <p className="font-light text-[16px] text-etGray mb-[12px]">Experience Harmonia: where melodies transcend boundaries. Immerse in captiva performances that ignite the stage. Unleash your musical senses and embrace rhyth mic bliss. &nbsp;where melodies transcend boundaries. Immerse in</p>
                  <p className="font-light text-[16px] text-etGray">Experience Harmonia: where melodies transcend boundaries. Immerse in captiva performances that ignite the stage. Unleash your musical senses and embrace rhyth mic bliss.</p>
                </div>
                <div className="flex flex-wrap gap-x-[40px] lg:gap-x-[20px] gap-y-[15px] items-center xxs:justify-center">
                  ...
                  <div className="flex items-center gap-x-[15px] border-r xxs:border-r-0 xxs:border-b border-[#d9d9d9] pr-[40px] lg:pr-[20px] xxs:pr-0 xxs:pb-[15px]">
                    ...
                    <div className="txt">
                      <h5 className="font-semibold text-[20px] text-etBlack mb-[2px]">Alexsia Jorgina</h5>
                      <span className="text-[15px] font-normal text-etGray">Co. Founder</span>
                    </div>
                  </div>
                  {/* signature */}
                  <div>
      ...
      <div className="et-history-timeline-slider swiper mt-[30px] lg:mt-[25px] border-t border-[rgba(217,217,217,0.2)]">
        <div className="swiper-wrapper">
          ...
          <div className="et-history-timeline swiper-slide pt-[54px] lg:pt-[34px] relative cursor-pointer">
            <div>
              <h3 className="font-semibold text-[70px] md:text-[60px] sm:text-[50px] leading-[0.8] text-transparent">1985</h3>
            </div>
          </div>
          {/* single timeline */}
          <div className="et-history-timeline swiper-slide pt-[54px] lg:pt-[34px] relative cursor-pointer">
            <div>
              <h3 className="font-semibold text-[70px] md:text-[60px] sm:text-[50px] leading-[0.8] text-transparent">1995</h3>
            </div>
          </div>
          {/* single timeline */}
          <div className="et-history-timeline swiper-slide pt-[54px] lg:pt-[34px] relative cursor-pointer">
            <div>
              <h3 className="font-semibold text-[70px] md:text-[60px] sm:text-[50px] leading-[0.8] text-transparent">2005</h3>
            </div>
          </div>
          {/* single timeline */}
          <div className="et-history-timeline swiper-slide pt-[54px] lg:pt-[34px] relative cursor-pointer">
            <div>
              <h3 className="font-semibold text-[70px] md:text-[60px] sm:text-[50px] leading-[0.8] text-transparent">2015</h3>
            </div>
          </div>
          {/* single timeline */}
          <div className="et-history-timeline swiper-slide pt-[54px] lg:pt-[34px] relative cursor-pointer">
            <div>
              <h3 className="font-semibold text-[70px] md:text-[60px] sm:text-[50px] leading-[0.8] text-transparent">2020</h3>
            </div>
          </div>
          {/* single timeline */}
          <div className="et-history-timeline swiper-slide pt-[54px] lg:pt-[34px] relative cursor-pointer">
            <div>
              <h3 className="font-semibold text-[70px] md:text-[60px] sm:text-[50px] leading-[0.8] text-transparent">2023</h3>
            </div>
          </div>
          {/* single timeline */}
          <div className="et-history-timeline swiper-slide pt-[54px] lg:pt-[34px] relative cursor-pointer">
            <div>
              <h3 className="font-semibold text-[70px] md:text-[60px] sm:text-[50px] leading-[0.8] text-transparent">2024</h3>
            </div>
          </div>
        </div>
      </div>
  ...
  <section className="et-speakers py-[130px] lg:py-[80px] md:py-[60px] overflow-hidden relative z-[1]">
    <div className="container mx-auto max-w-[1200px] px-[12px] xl:max-w-full">
      ...
      <div className="et-speakers-heading text-center mb-[46px] xl:mb-[26px] lg:mb-[16px] gap-[15px]">
        ...
        <h2 className="et-section-title anim-text">Meet Our Creative Speakers</h2>
      </div>
      <div className="grid grid-cols-3 md:grid-cols-3 sm:grid-cols-2 xxs:grid-cols-1 justify-center gap-[30px] lg:gap-[20px]">
        ...
        <div className="et-member group">
          <div className="et-member__img rounded-[16px] overflow-hidden">
            <img src="assets/img/team-member-1.jpg" alt="Team Member Image" className="w-full duration-[400ms] group-hover:scale-110" />
          </div>
          <div className="et-member__txt bg-white relative z-[1] mx-[25px] md:mx-[15px] xs:mx-[5px] -mt-[44px] md:-mt-[15px] xs:mt-0 rounded-[16px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] before:w-full before:absolute before:-z-[1] before:h-full before:bg-white before:left-0 before:rounded-[16px] before:-top-[33px] before:skew-y-[4deg]">
            <div className="et-member-socials absolute right-[20px] -top-[43px]">
              <div className="et-speaker__socials flex flex-col gap-[8px] absolute -z-[2] text-[14px] opacity-0 transition duration-[400ms] bottom-[calc(100%+8px)] translate-y-[100%] group-hover:translate-y-0 group-hover:opacity-100">
                <a href="#" className="border border-white text-white w-[36px] h-[36px] flex items-center justify-center rounded-full hover:border-etBlue hover:bg-etBlue"><i className="fa-brands fa-facebook-f" /></a>
                <a href="#" className="border border-white text-white w-[36px] h-[36px] flex items-center justify-center rounded-full hover:border-etBlue hover:bg-etBlue"><i className="fa-brands fa-x-twitter" /></a>
                <a href="#" className="border border-white text-white w-[36px] h-[36px] flex items-center justify-center rounded-full hover:border-etBlue hover:bg-etBlue"><i className="fa-brands fa-linkedin-in" /></a>
                <a href="#" className="border border-white text-white w-[36px] h-[36px] flex items-center justify-center rounded-full hover:border-etBlue hover:bg-etBlue"><i className="fa-brands fa-instagram" /></a>
              </div>
            ...
            <h5 className="font-semibold text-[22px] md:text-[20px] text-etBlack mb-[4px]"><a href="team-member-details.html" className="hover:text-etBlue">Darlene Robertson</a></h5>
            <span className="text-etGray text-[16px]">Web Designer</span>
          </div>
        </div>
        {/* single team member */}
        <div className="et-member group">
          <div className="et-member__img rounded-[16px] overflow-hidden">
            <img src="assets/img/team-member-2.jpg" alt="Team Member Image" className="w-full duration-[400ms] group-hover:scale-110" />
          </div>
          <div className="et-member__txt bg-white relative z-[1] mx-[25px] md:mx-[15px] xs:mx-[5px] -mt-[44px] md:-mt-[15px] xs:mt-0 rounded-[16px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] before:w-full before:absolute before:-z-[1] before:h-full before:bg-white before:left-0 before:rounded-[16px] before:-top-[33px] before:skew-y-[4deg]">
            <div className="et-member-socials absolute right-[20px] -top-[43px]">
              <div className="et-speaker__socials flex flex-col gap-[8px] absolute -z-[2] text-[14px] opacity-0 transition duration-[400ms] bottom-[calc(100%+8px)] translate-y-[100%] group-hover:translate-y-0 group-hover:opacity-100">
            ...
            <h5 className="font-semibold text-[22px] md:text-[20px] text-etBlack mb-[4px]"><a href="team-member-details.html" className="hover:text-etBlue">Leslie Alexander</a></h5>
        ...
        <div className="et-member group">
          <div className="et-member__img rounded-[16px] overflow-hidden">
            <img src="assets/img/team-member-3.jpg" alt="Team Member Image" className="w-full duration-[400ms] group-hover:scale-110" />
          </div>
          <div className="et-member__txt bg-white relative z-[1] mx-[25px] md:mx-[15px] xs:mx-[5px] -mt-[44px] md:-mt-[15px] xs:mt-0 rounded-[16px] shadow-[0_4px_60px_rgba(18,96,254,0.12)] px-[25px] md:px-[15px] pb-[30px] md:pb-[20px] before:w-full before:absolute before:-z-[1] before:h-full before:bg-white before:left-0 before:rounded-[16px] before:-top-[33px] before:skew-y-[4deg]">
            <div className="et-member-socials absolute right-[20px] -top-[43px]">
              <div className="et-speaker__socials flex flex-col gap-[8px] absolute -z-[2] text-[14px] opacity-0 transition duration-[400ms] bottom-[calc(100%+8px)] translate-y-[100%] group-hover:translate-y-0 group-hover:opacity-100">
            ...
            <h5 className="font-semibold text-[22px] md:text-[20px] text-etBlack mb-[4px]"><a href="team-member-details.html" className="hover:text-etBlue">Cameron Williamson</a></h5>
  ...
  <section className="text-center py-[130px] xl:py-[80px] md:py-[60px] bg-[url(../assets/img/stats-bg.jpg)] bg-no-repeat bg-cover relative z-[1] before:absolute before:inset-0 before:bg-etBlue/85 before:-z-[1]">
    <div className="container mx-auto max-w-[calc(100%-37.1vw)] xxxl:max-w-[calc(100%-350px)] xl:max-w-[calc(100%-170px)] px-[12px] lg:max-w-full rev-slide-up">
      ...
      <a href="#" className="bg-white inline-flex items-center gap-[12px] rounded-full text-etBlue h-[54px] px-[15px] text-[17px] group hover:bg-etBlue hover:text-white">
        <span className="icon">
